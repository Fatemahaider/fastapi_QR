...
@app.post("/save_data/")
async def save_1(type:str,value:str,mac_add:str,login_code: int, scan_time: str):
    d = {'type':type,'value':value,'mac_add':mac_add,'login_code':login_code,'scan_time':scan_time}
